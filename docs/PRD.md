...
This pass closes the *structural* gaps (schema/workflow-level, expensive to retrofit) and a few
...
- **Status state machine** (Task Engine): now specifies the *full* PRD status model (New → AI
